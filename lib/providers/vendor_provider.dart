  ...
  List<DestinationModel> _getDefaultDestinations() {
    return [
      ...
      DestinationModel(
        ...
        description: 'Serene backwater weddings with luxury houseboat processions, lakefront mandaps, and traditional Sadya feast.',
        ...
        packages: [
          DestinationPackage(
            id: 401,
            packageName: 'Kumarakom Lake Resort Heritage Mandap',
            price: 3400000.0,
            duration: '3 Days / 2 Nights',
            inclusions: ['Vembanad Lakefront Floral Altar', 'Heritage Pool Villas for Couple', 'Sunset Kettuvallam Houseboat Cruise', 'Royal Kerala Sadya & Chenda Melam'],
          ),
          DestinationPackage(
            id: 402,
            packageName: 'Taj Kumarakom 140-Year Colonial Gala',
            price: 3200000.0,
            duration: '3 Days / 2 Nights',
            inclusions: ['Colonial Bungalow Lagoon Lawn', 'Heritage Lagoon View Suites for 150 Guests', 'Kathakali Dance & Lamp Ceremony', 'Taj Fine Culinary Feast'],
          ),
          DestinationPackage(
            id: 403,
            packageName: 'The Zuri Kumarakom Lagoon & Lawn Wedding',
            price: 2800000.0,
            duration: '3 Days / 2 Nights',
            inclusions: ['Private Lagoon Island Mandap', 'Vembanad Lake View Cottages Stay', 'Ayurvedic Spa Pampering for Couple', 'Seafood & Multi-Cuisine Banquet'],
          ),
          DestinationPackage(
            id: 404,
            packageName: 'Ramada Alleppey Punnamada Lake Experience',
            price: 2400000.0,
            duration: '3 Days / 2 Nights',
            inclusions: ['Punnamada Lakefront Stage & Mandap', 'Luxury Kettuvallam Procession for Groom', 'Rooftop Poolside Sangeet Party', 'Traditional Sadya & Continental Buffet'],
          ),
          DestinationPackage(
            id: 405,
            packageName: 'The Leela Kovalam Cliffside & Backwater Gala',
            price: 3500000.0,
            duration: '3 Days / 2 Nights',
            inclusions: ['Arabian Sea Cliff Pavilion Mandap', 'Royal Club Ocean Suites Stay', 'Infinity Pool Sunset Cocktail Deck', 'Global Gourmet Culinary Feast'],
          ),
          DestinationPackage(
            id: 406,
            packageName: 'Marari Beach Eco-Luxury Coconut Grove Wedding',
            price: 2600000.0,
            duration: '3 Days / 2 Nights',
            inclusions: ['Marari White Sand Beach Altar', 'Thatched Roof Eco Villas for 120 Guests', 'Organic Farm-to-Table Kerala Feast', 'Violin & Acoustic Sea Breeze Sangeet'],
          ),
          DestinationPackage(
            id: 407,
            packageName: 'Grand Hyatt Kochi Bolgatty Island Celebration',
            price: 3000000.0,
            duration: '3 Days / 2 Nights',
            inclusions: ['Bolgatty Island Waterway Lawn Mandap', 'Grand Waterfront Ballroom Stage', 'Luxury Marina Suites for 200 Guests', '5-Star Hyatt International Feast'],
          ),
          DestinationPackage(
            id: 408,
            packageName: 'Spice Village Periyar Eco Plantation Gala',
            price: 2300000.0,
            duration: '3 Days / 2 Nights',
            inclusions: ['Spice Plantation Garden Mandap', 'Tribal Folk Music & Fireplace Night', 'Elephant Welcome Procession', 'Traditional Earth-Cooked Feast'],
          ),
          DestinationPackage(
            id: 409,
            packageName: 'Fragrant Nature Munnar Mist Mountain Package',
            price: 2200000.0,
            duration: '3 Days / 2 Nights',
            inclusions: ['Tea Garden Mist View Mandap', 'Luxury Mountain Chalets Stay', 'Bonfire & Acoustic Sangeet Night', 'Highland Fusion Gastronomy'],
          ),
          DestinationPackage(
            id: 410,
            packageName: 'Nattika Beach Palm Grove Wellness Celebration',
            price: 2500000.0,
            duration: '3 Days / 2 Nights',
            inclusions: ['Palm Grove Beach Altar Setup', 'Ayurvedic Wellness Spa for Couple', 'Seaside Sunset Mandap', 'Pure Sattvik & Seafood Dining'],
          ),
        ],
      ),
      DestinationModel(
